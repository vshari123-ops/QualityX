          ...
          <Card className="overflow-hidden">
            <div className="grid gap-8 md:grid-cols-3">
              ...
              <div className="md:col-span-1">
                <div className="relative aspect-square overflow-hidden rounded-lg bg-gradient-to-br from-primary-100 to-accent-100">
                  {/* Image placeholder - to be replaced with actual photo */}
                  ...
                  <div className="absolute inset-0 flex items-end justify-center bg-gradient-to-t from-black/50 to-transparent p-4">
                    <p className="text-xs text-white/80">Photo coming soon</p>
                  </div>
                </div>
              </div>
