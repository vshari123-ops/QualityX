...
const caseStudies = [
  {
    ...
    challenge: "As a growing Singapore-based startup focused on software development and applications, Purands needed QA engineers and software developers to accelerate their product development and build innovative solutions.",
    solution: "QualityX implemented a targeted TVD program to identify and train candidates with strong foundations in quality assurance and modern software development practices, ensuring they were ready to contribute to Purands' AI-driven initiatives.",
    results: [
      { metric: "6", label: "Engineers Placed" },
      { metric: "4 wks", label: "Time to Deploy" },
      { metric: "100%", label: "Retention Rate" },
      { metric: "QA", label: "Specialization" },
    ],
    testimonial: {
      quote: "QualityX understood our unique needs as a startup. The QA engineers and developers they provided integrated seamlessly with our team and have been instrumental in driving our product innovation forward.",
      author: "Roy Lim",
